...
program: 				function_decl MAINSYM LBRACE statement_list RBRACE 
						;
...
declaration_stat:		typeenum identlist SEMICOLONSTAT 
					  | typeenum identarraylist  SEMICOLON
					  | CONSTSYM typeenum identlist SEMICOLON
					  | CONSTSYM typeenum identarraylist SEMICOLON;
						;
...
case_stat:				CASESYM expression COLON  compound_statement 
					  | 
						;
...
if_statement:		  	IFSYM LPARENSTAT expression RPARENSTAT compound_statement else_list 
						;

else_list:				ELSESYMSTAT compound_statement 
					  |	
						;
...
while_statement:		WHILESYMSTAT LPARENSTAT expression RPARENSTAT  compound_statement 
						;
...
for_statement:			FORSYM LPARENSTAT expression SEMICOLONSTAT expression SEMICOLONSTAT expression RPARENSTAT INC_OR_NOT compound_statement 
						;
						
INC_OR_NOT:				
						;

do_statement:			DOSYM compound_statement WHILESYM LPAREN expression RPARENSTAT SEMICOLONSTAT
						;
